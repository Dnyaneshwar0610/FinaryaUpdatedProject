...
public class UserLogin {
	public String Path =System.getProperty("user.dir")+"/src/test/java/com/csipl/finarya/testdata/TC_LoginNoOfUser.xlsx";

	@DataProvider(name = "userloginscenario")
	public Object[][] loginData() {
		Object[][] arrayObject = getExcelData(Path, "log");
		return arrayObject;
	}
