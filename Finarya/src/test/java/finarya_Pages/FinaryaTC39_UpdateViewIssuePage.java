...
public class FinaryaTC39_UpdateViewIssuePage {

	public propertiesHandler prop = new propertiesHandler();
	public static final String PROPERTY_FILE = "TC39_UpdateViewIssue.properties";
	WebDriver driver;
	public Finarya_AuditModulePage Audit;

	public FinaryaTC39_UpdateViewIssuePage(WebDriver driver) {
		this.driver = driver;
	...
	public void searchrecord() {
		try {
			...
			if (searctext.equalsIgnoreCase(Actual)) {
				Reporter.log("AS PER TEST STEP UPDATE ICON IS NOT PRESENT ON LIST ISSUE");
