...
public class FinaryaTC10_ListProductPage {

	WebDriver driver;
	Finarya_AdministrationModule mainmodule;

	public FinaryaTC10_ListProductPage(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	@FindAll({ @FindBy(how = How.XPATH, using = "//*[@id='csi-dt-product_length']/label/select"),
			@FindBy(how = How.CSS, using = "#csi-dt-product_length > label > select") })
	...
	@FindAll({ @FindBy(how = How.XPATH, using = "//*[@id='csi-dt-product_info']"),
			@FindBy(how = How.CSS, using = "#csi-dt-product_info") })
	...
	public void clickonlistproduct() {
		...
		Reporter.log("System will open page List Product Master with Search Functionality at various levels" + ""
