...
public class FinaryaTC25_ListRiskPage {

	WebDriver driver;
	Finarya_RiskManagementModule mainrisk;

	public FinaryaTC25_ListRiskPage(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	@FindAll({ @FindBy(how = How.XPATH, using = "//*[@id='csi-dt-risk_length']/label/select"),
			@FindBy(how = How.CSS, using = "#csi-dt-risk_length > label > select") })
	...
	@FindAll({ @FindBy(how = How.XPATH, using = "//*[@id='csi-dt-risk_info']"),
			@FindBy(how = How.CSS, using = "#csi-dt-risk_info") })
	WebElement ListEntriesInfo;

	public void clickonlistrisk() {
		mainrisk = new Finarya_RiskManagementModule(driver);
		mainrisk.riskmanagement.click();		
		mainrisk.riskandcontrollibrary.click();
		mainrisk.risklibrary.click();
		mainrisk.listrisk.click();
